...
namespace Assets.Scripts.Ui
{
    public class TestTurretButton : MonoBehaviour
    {
        ...
        /// <summary>
        /// Evaluates whether a TurretSpawnPoint meets the condition and returns true if it does.
        /// </summary>
        /// <remarks>
        /// <para>- DeployTurret → Requires the slot to be unlocked and empty.</para>
        /// <para>- AddSlot → Targets locked slots only.</para>
        /// <para>- SellTurret → Selects slots that already contain a turret.</para>
        /// </remarks>
        ...
        {
            public const string TurretType = nameof(TestTurretButton.TurretbuttonType);
            public const string Prefab = nameof(TestTurretButton._turretPrefab);
            public const string Cost = nameof(TestTurretButton._cost);
            public const string Refund = nameof(TestTurretButton._moneyToGiveBack);
